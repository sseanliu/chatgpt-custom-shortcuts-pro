...
A Chrome extension providing customizable keyboard shortcuts and enhanced features for ChatGPT.

Install from the [Chrome Web Store](https://chromewebstore.google.com/detail/chatgpt-custom-shortcuts/figoaoelbmlhipinligdgmopdakcdkcf).

The full [Changelog](#changelog) is now maintained exclusively in this readme.

##### Smooth Scrolling
- **Scroll Up One Message:** `Alt + a`
- **Scroll Down One Message:** `Alt + f`
- **Scroll to Top:** `Alt + t`
...
- **Select and Copy (Markdown preserved):** `Alt + x`
- **Join and Copy All Responses:** `Alt + [`
- **Join and Copy All Code Blocks:** `Alt + ]`

##### Chat Controls
- **Start New Conversation:** `Alt + n`
- **Focus Chat Input:** `Alt + w`
- **Toggle Sidebar:** `Alt + s`
- **Toggle Sidebar Folders:** `Alt + g` *(state persists after refresh)*
- **Search Chats:** `Alt + k`
- **Toggle "Search the Web" Button:** `Alt + q`

##### Sending & Editing
- **Send Message:** `Ctrl + Enter` *(optionally disabled)*
- **Stop Generation:** `Ctrl + Backspace` *(optionally disabled)*
- **Edit Message:** `Alt + e`
- **Resend Edited Message:** `Alt + d`

##### Navigation
- **Previous Thread:** `Alt + j`
- **Next Thread:** `Alt + ;`
